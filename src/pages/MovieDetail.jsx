...
const MovieDetail = () => {
  const params = useParams();
  const [movie, setMovie] = useState(null); // use null to detect loading

  // Optional chaining ensures no crash when title is undefined
  ...
  if (!movie) {
    return <p className="text-center mt-10 text-lg">Loading movie details...</p>;
  }
